"""
Django settings for e_graveyard project.
...
SECRET_KEY = "django-insecure-ks_htcsr77-p7(1&#p)^v(=bp_w!-r^%xbu2kzuizz8vzmkp@2"
...
WSGI_APPLICATION = "e_graveyard.wsgi.application"
